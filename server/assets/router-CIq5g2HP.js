...
function SiteHeader() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 border-b border-border/60 bg-background/80 backdrop-blur-xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-18 max-w-7xl items-center justify-between gap-6 px-4 py-3 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "Зурбаган", className: "h-11 w-11 object-contain" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-lg font-bold tracking-tight", children: "ЗУРБАГАН" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-[0.2em] text-muted-foreground", children: "Internet · TV" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden lg:flex items-center gap-1", children: nav.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: item.to,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "tel:+380673002200", className: "flex items-center gap-2 text-sm font-semibold text-foreground/80 hover:text-foreground", children: [
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden border-t border-border bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 py-4 space-y-1", children: [
...
function SiteFooter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "mt-24 border-t border-border bg-surface", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 py-14 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-10 md:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "Зурбаган", className: "h-10 w-10 object-contain" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-lg font-bold", children: "ЗУРБАГАН" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm text-muted-foreground", children: "Оператор кабельного ТБ та інтернет-провайдер у Конотопі. З вами з 2002 року." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-semibold uppercase tracking-wider text-muted-foreground", children: "Навігація" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 space-y-2 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", className: "hover:text-brand", children: "Послуги" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/tariffs", className: "hover:text-brand", children: "Тарифи" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/instructions", className: "hover:text-brand", children: "Інструкції" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/support", className: "hover:text-brand", children: "Підтримка" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/offer", className: "hover:text-brand", children: "Публічна оферта" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-semibold uppercase tracking-wider text-muted-foreground", children: "Контакти" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 space-y-3 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-4 w-4 mt-0.5 text-brand" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+380673002200", className: "block hover:text-brand", children: "067 300 22 00" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+380663002200", className: "block hover:text-brand", children: "066 300 22 00" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+380732002200", className: "block hover:text-brand", children: "073 200 22 00" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-4 w-4 text-brand" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:info@zurbagan.tv", className: "hover:text-brand", children: "info@zurbagan.tv" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-semibold uppercase tracking-wider text-muted-foreground", children: "Графік роботи" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 space-y-2 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-4 w-4 text-brand" }),
            " Пн–Пт: 9:00–18:00"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "pl-6 text-muted-foreground", children: "Перерва 13:00–14:00" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "pl-6 text-muted-foreground", children: "Сб–Нд: вихідні" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 flex flex-col items-center justify-between gap-4 border-t border-border pt-6 text-xs text-muted-foreground md:flex-row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Зурбаган. Усі права захищені."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Світ інформації та розваг" })
    ] })
  ] }) });
}
...
const Route$7 = createFileRoute("/tariffs")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Тарифні плани з безлімітним трафіком: Ethernet та GPON. Від 200 грн/міс. IPTV у подарунок."
    }]
  }),
...
const Route$6 = createFileRoute("/support")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Цілодобова підтримка абонентів: телефон, Telegram-бот, Viber та особистий кабінет."
    }]
  }),
...
const Route$5 = createFileRoute("/services")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Інтернет за технологіями Ethernet та GPON, цифрове IPTV, підключення для бізнесу."
    }]
  }),
...
const Route$4 = createFileRoute("/payment")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Способи оплати інтернету: Приват24, банківська картка, скретч-картка, Telegram-бот."
    }]
  }),
...
const Route$3 = createFileRoute("/offer")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Публічна оферта про надання послуг доступу до мережі Інтернет та кабельного ТБ."
    }]
  }),
...
const Route$2 = createFileRoute("/instructions")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Інструкції з підключення інтернету, налаштування роутерів, IPTV та оплати послуг."
    }]
  }),
...
const Route$1 = createFileRoute("/contacts")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Контакти Зурбаган: телефони, email, адреса, графік роботи. Залиште заявку на підключення."
    }]
  }),
...
const TariffsRoute = Route$7.update({
  id: "/tariffs",
  path: "/tariffs",
  getParentRoute: () => Route$8
});
const SupportRoute = Route$6.update({
  id: "/support",
  path: "/support",
  getParentRoute: () => Route$8
});
...
const PaymentRoute = Route$4.update({
  id: "/payment",
  path: "/payment",
  getParentRoute: () => Route$8
});
...
const InstructionsRoute = Route$2.update({
  id: "/instructions",
  path: "/instructions",
  getParentRoute: () => Route$8
});
